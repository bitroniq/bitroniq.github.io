...
Template: Piotr Kowalski RESUME
Author: piotrkowalski.info
Version: 1.1 
Design and Developed by: piotrkowalski.info
...
*************************/
  var win = $(window),
      foo = $('#typer');
      foo.typer(['<h2>System Admin</h2>', '<h2>DevOps - Development Operations Engineer</h2>', '<h2>Web Developer</h2>' ]);           
            win.resize(function(){
